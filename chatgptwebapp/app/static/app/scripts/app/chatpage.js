...
// Main
/////////////////////////////////////////
const image_path = 'static/app/images/';
let chatpage = "p0000"; // 初回に開くページ
let apiType = "chatGPT"; // 初回に開くページのapiType
let now_session_id = 0; // 現在の会話ID
let now_session_data = []; // 現在会話画面における会話履歴データ
let debate_stage = 1; // ディベートのステージ
...
const whileTypingCharactor = '<span id="cursor"></span>&nbsp;';
// 左部のメニュークリックイベント
$(function () {
...
function chatui_loadpage(page) {
    ...
    // Mainページの読み込み
    let chatpagehtml = '../static/app/html/chatui_' + chatpagehtmlfile + '.html';
    $('#chatui-pp').load(chatpagehtml, function () {
        ...
        if (apiType == 'search') {
            getlist_of_registered_document().then(data => {
                let list_of_registered_document = data;
                let option_html = '';
            ...
            // body
            let modal_html = '<button class="btn btn-success btn-sm" onclick="chat_Button_Click(\'modal_input\')" style="margin-bottom:10px;width:100%;" data-bs-dismiss="modal" aria-label="Close">このプロンプトを使う</button>\
        ...
        // @ts-ignore
        hljs.highlightAll();
        const windowwidth = (_a = $(window).width()) !== null && _a !== void 0 ? _a : 0;
        if (windowwidth < 1400) {
...
globalThis.chat_Button_Click = (e) => {
    ...
    let querydata = "";
    let searchflg = "off"; // デフォルトは検索オフ
    searchflg = (_c = (_b = (_a = $('#browseflg')) === null || _a === void 0 ? void 0 : _a.val()) === null || _b === void 0 ? void 0 : _b.toString()) !== null && _c !== void 0 ? _c : 'off';
    $('#inputtextarea').val('');
    $('#inputtextarea').css('height', "60px");
    let htmltext = '<div class="clearfix li-option me-balloon"><div class="message-data smartphone-display"><img src="static/app/images/me.png" alt="avatar"></div><div class="message other-message-input smartphone-padding">@@displaytext@@</div></div>';
    // プロンプトの生成処理
    for (let k = 0; k < pageData.length; k++) {
        if (pageData[k].page_id === chatpage) {
            // apiType = pageData[k].apiType;
            if (apiType === "summary") {
                ...
                for (let i = 0; i < pageData[k].req_replacewords.length; i++) {
                    querydata = (_e = (_d = $('#textarea' + (i + 1)).val()) === null || _d === void 0 ? void 0 : _d.toString()) !== null && _e !== void 0 ? _e : '';
                }
                ...
                const document_name = (_g = (_f = $('#textarea1').val()) === null || _f === void 0 ? void 0 : _f.toString()) !== null && _g !== void 0 ? _g : '';
                const description = (_j = (_h = $('#textarea2').val()) === null || _h === void 0 ? void 0 : _h.toString()) !== null && _j !== void 0 ? _j : '';
                const inputElement = document.querySelector('#formFileSm');
                const uploadfile = (_l = (_k = inputElement.files) === null || _k === void 0 ? void 0 : _k[0]) !== null && _l !== void 0 ? _l : null;
                let errorflg = false;
                ...
                console.log("uploadfile name" + (uploadfile === null || uploadfile === void 0 ? void 0 : uploadfile.name.slice(-4)));
                if ((uploadfile === null || uploadfile === void 0 ? void 0 : uploadfile.name.slice(-4)) !== ".pdf") {
                ...
                // fileuploadの場合は、Formsにセットするしてそのまま送信する
                const inputElement = document.querySelector('#formFileSm');
                const uploadfile = (_o = (_m = inputElement.files) === null || _m === void 0 ? void 0 : _m[0]) !== null && _o !== void 0 ? _o : null;
                let errorflg = false;
                if (uploadfile == null) {
                    alert('ファイルを選択してください');
                    errorflg = true;
                ...
                console.log("uploadfile name" + (uploadfile === null || uploadfile === void 0 ? void 0 : uploadfile.name.slice(-4)));
                if ((uploadfile === null || uploadfile === void 0 ? void 0 : uploadfile.name.slice(-4)) !== ".csv") {
                ...
                for (let i = 0; i < pageData[k].req_replacewords.length; i++) {
                    querydata = querydata.replace(pageData[k].req_replacewords[i], (_q = (_p = $('#textarea' + (i + 1)).val()) === null || _p === void 0 ? void 0 : _p.toString()) !== null && _q !== void 0 ? _q : '');
                }
                postStreamingChatGptResponse(querydata, get_convId(), apiType, searchflg); // ChatGPTに直接送信
            }
            else if (apiType === "Debate" || apiType === "Meeting") {
                if (e != "modal_input") {
                    querydata = pageData[k].req_template;
                    for (let i = 0; i < pageData[k].req_replacewords.length; i++) {
                        querydata = querydata.replace(pageData[k].req_replacewords[i], (_s = (_r = $('#textarea' + (i + 1)).val()) === null || _r === void 0 ? void 0 : _r.toString()) !== null && _s !== void 0 ? _s : '');
                    }
                }
                else {
                    querydata = (_u = (_t = $('#prompt_text').val()) === null || _t === void 0 ? void 0 : _t.toString()) !== null && _u !== void 0 ? _u : '';
                    for (let i = 0; i < pageData[k].in_examples.length; i++) {
                ...
                if (e != "modal_input") {
                    querydata = pageData[k].req_template;
                    for (let i = 0; i < pageData[k].req_replacewords.length; i++) {
                        querydata = querydata.replace(pageData[k].req_replacewords[i], (_w = (_v = $('#textarea' + (i + 1)).val()) === null || _v === void 0 ? void 0 : _v.toString()) !== null && _w !== void 0 ? _w : '');
                    }
                }
                else {
                    querydata = (_y = (_x = $('#prompt_text').val()) === null || _x === void 0 ? void 0 : _x.toString()) !== null && _y !== void 0 ? _y : '';
                    for (let i = 0; i < pageData[k].in_examples.length; i++) {
                        $('#textarea' + (i + 1)).prop('disabled', true);
                    }
                    htmltext = htmltext.replace(/@@displaytext@@/g, querydata);
            ...
            for (let i = 0; i < pageData[k].req_replacewords.length; i++) {
                let temptext = (_0 = (_z = $('#textarea' + (i + 1)).val()) === null || _z === void 0 ? void 0 : _z.toString()) !== null && _0 !== void 0 ? _0 : '';
                $('#textarea' + (i + 1)).html(temptext);
            }
        }
    }
};
globalThis.clear_Button_Click = (e) => {
...
globalThis.sse_Close_Button_Click = (e) => {
    sse.close();
    sse2.close();
};
globalThis.print_Button_Click = (e) => {
    printDiv('chatui-pp');
};
globalThis.edit_Button_Click = (e) => {
    var _a, _b;
    console.log('edit_button click');
    for (let k = 0; k < pageData.length; k++) {
        if (pageData[k].page_id === chatpage) {
            let prompt_text = pageData[k].req_template;
            for (let i = 0; i < pageData[k].req_replacewords.length; i++) {
                prompt_text = prompt_text.replace(pageData[k].req_replacewords[i], (_b = (_a = $('#textarea' + (i + 1)).val()) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '');
            }
...
globalThis.menuopen_Button_Click = (e) => {
...
globalThis.input_Textarea_Button_Click = (e) => {
    var _a, _b, _c, _d, _e;
    console.log('input_textarea_button click');
    debate_stage = 9999;
    let inputText = (_b = (_a = $('#inputtextarea').val()) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '';
    var $myList = $('#chatul');
    ...
    $('#inputtextarea').css('height', "60px");
    $('#send_button').prop('disabled', true);
    let searchflg = (_e = (_d = (_c = $('#browseflg')) === null || _c === void 0 ? void 0 : _c.val()) === null || _d === void 0 ? void 0 : _d.toString()) !== null && _e !== void 0 ? _e : '';
    $('#browseflg').prop('disabled', true);
...
globalThis.detail_Button_Click = (e) => {
    console.log('detail_Button_Click click');
    let select_option_list = $('#multiselect').val();
    // alert("value=" + r );
};
globalThis.catalog_Button_Click = (e) => {
    var _a, _b;
    console.log('catalog_Button_Click click');
    let row_count = e;
    let inputText = (_b = (_a = $('#catalog-input-' + row_count).val()) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '';
...
$("#inputtextarea").on("keyup", function (e) {
    ...
    if (e.keyCode == 13) { // Enterが押された
        if (e.shiftKey) { // Shiftキーも押された
            ...
            let inputTemp = (_b = (_a = $('#inputtextarea').val()) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '';
            if (inputTemp.trim() !== '') {
                $('#inputtextarea').css('height', "60px");
                $('#inputtextarea').val('');
            }
...
function inputtextareacommon(e) {
    var _a, _b;
...
globalThis.textarea_Output = (e) => {
    //- 改行に合わせてテキストエリアのサイズ変更
    var _a;
    // textareaタグを全て取得
    const e_id = (_a = $(e).attr('id')) !== null && _a !== void 0 ? _a : "";
...
function resizeWindow() {
    ...
    const windowWidthWithAsobi = windowheight - 10; // 10pxは余裕を持たせる
}
let convIdCounter = 0;
function get_convId() {
    convIdCounter += 1;
...
function debateControl(query, apiType, searchflg) {
        ...
        if (apiType === "Debate") {
            switch (debate_stage) {
                ...
                case 1:
                    ...
                    prompttext = query;
                    yield postStreamingChatGptResponse(prompttext, get_convId(), apiType, searchflg); // ChatGPTに直接送信
                    break;
                // 2. 主張Bの反対尋問\n\
                case 2:
...
var sse;
// ChatGPTへの呼び出し
function postStreamingChatGptResponse(query, convId, apiType, searchflg) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log('postStreamingChatGptResponse');
        if (now_session_id == 0) {
            now_session_id = yield getIdHttpResponse("session_id");
        }
        ...
        let alltext = "";
        let firstflg = false;
        let whileTypingCharactor_temp = whileTypingCharactor;
        let apiUrl = "";
        let sendData = "";
        let searchtemp = "";
        let p_temp;
...
var sse2;
// ChatGPTへの呼び出し
function postCodeInterpreterResponse(query, convId, apiType) {
    return __awaiter(this, void 0, void 0, function* () {
...
// 採番されたIdの取得
function getIdHttpResponse(id_name) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch(baseurl + `getid?id_name=` + id_name);
...
// 登録されたドキュメント情報の取得
function getlist_of_registered_document() {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch(baseurl + `getlist_of_registered_document`);
        let res = yield response.json();
...
// 会話履歴の保存
function postHistoryHttpResponse() {
    return __awaiter(this, void 0, void 0, function* () {
...
// ファイルのアップロード
function postPdfFileuploadHttpResponse(document_name, description, file, convId) {
    return __awaiter(this, void 0, void 0, function* () {
        // 回答の吹出しを用意
        var $myList = $('#chatul');
        $myList.append('<div id="outputdiv" class="clearfix li-option ai-balloon"><div class="message-data smartphone-display"><img id="pimg" src="static/app/images/ai.png" alt="avatar"></div><div class="message my-message markdown-body smartphone-padding" id="resmessege' + convId.toString() + '"></div></div>');
        ...
        const response = yield fetch(baseurl + `document_upload_save`, data)
            .then((response) => {
...
// Sqlのテーブルのヘッダーを取得
function postGetSqlTableHeadHttpResponse(convId) {
    return __awaiter(this, void 0, void 0, function* () {
        // 回答の吹出しを用意
        var $myList = $('#chatul');
        $myList.append('<div id="outputdiv" class="clearfix li-option ai-balloon"><div class="message-data smartphone-display"><img id="pimg" src="static/app/images/ai.png" alt="avatar"></div><div class="message my-message markdown-body smartphone-padding" id="resmessege' + convId.toString() + '"></div></div>');
        ...
        const response = yield fetch(baseurl + `code_interpreter_sql_get_tablelayout`, data)
            .then((response) => {
            return (response.json()).then((data) => {
                if (data.status.includes("OK")) {
                    $('#chat_button_spin').hide();
                    ...
                    // @ts-ignore
                    let datarayout = marked.parse(data.datarayout.trimEnd());
                    // @ts-ignore
                    let data_describe = marked.parse(data.data_describe.trimEnd());
                    datarayout = datarayout.replace('<table>', '<table class="ci-table" style="overflow-x: auto; overflow-y: auto; max-height: 600px;">');
                    // @ts-ignore
                    let dateime_columns = marked.parse(data.dateime_columns.trimEnd());
                    let outtexthtml = "データの読み込みができました。ご要望をどうぞ。<br/><br/>"
...
// ファイルのアップロード
function postCsvFileuploadHttpResponse(file, presetfile, convId) {
    return __awaiter(this, void 0, void 0, function* () {
        // 回答の吹出しを用意
        var $myList = $('#chatul');
        $myList.append('<div id="outputdiv" class="clearfix li-option ai-balloon"><div class="message-data smartphone-display"><img id="pimg" src="static/app/images/ai.png" alt="avatar"></div><div class="message my-message markdown-body smartphone-padding" id="resmessege' + convId.toString() + '"></div></div>');
        ...
        const response = yield fetch(baseurl + `code_interpreter_upload_csv`, data)
            .then((response) => {
            return (response.json()).then((data) => {
                if (data.status.includes("OK")) {
                    // console.log(data.status);
